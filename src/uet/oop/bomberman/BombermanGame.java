...
public class BombermanGame extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        canvas.setTranslateY(SCALED_SIZE);
        Label label = new Label("Nhấn P để tắt nhạc nền                 Nhấn M để mở lại ");
        label.setFont(Font.font("Cambodia", 23));
        ...
        Sound theme = new Sound(Sound.theme);
